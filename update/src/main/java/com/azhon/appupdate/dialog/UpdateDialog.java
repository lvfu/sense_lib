...
public class UpdateDialog extends Dialog implements View.OnClickListener, OnDownloadListener {
    ...
    private int dialogThemeColor = 1;
    ...
    private void init(Context context) {
        ...
        dialogThemeColor = manager.getDialogThemeColor();
    ...
    private void initView(View view) {
        ...
        description.setText(Html.fromHtml(manager.getApkDescription()));

        RelativeLayout bacRl = view.findViewById(R.id.dialog_bac_rl);

        //设置背景图以及按钮颜色  * 1 蓝   2 红  3 绿
        if (1 == dialogThemeColor) {
            bacRl.setBackgroundResource(R.drawable.xitonggegnxin);
            update.setBackgroundResource(R.drawable.self_blue_fifty_cor_normal_bac);

        } else if (2 == dialogThemeColor) {
            bacRl.setBackgroundResource(R.drawable.xitonggegnxin_red);
            update.setBackgroundResource(R.drawable.self_red_fifty_cor_normal_bac);

        } else if (3 == dialogThemeColor) {
            bacRl.setBackgroundResource(R.drawable.xitonggegnxin_green);
            update.setBackgroundResource(R.drawable.self_green_fifty_cor_normal_bac);
